...
void loop() {
  ...
  client.publish("esp32/kamer1/temp", payload.c_str());

  if (digitalRead(27) == HIGH) {
    client.publish("esp32/kamer1/set", "airco1-AAN");
    Serial.println("A1");
  }

  if (digitalRead(26) == HIGH) {
    client.publish("esp32/kamer1/set", "verwarming1-AAN");
    Serial.println("V1");
  }
